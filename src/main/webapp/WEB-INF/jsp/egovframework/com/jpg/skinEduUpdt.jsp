                        ...
                        <table class="wTable" summary="게시글의 내역에 대한 목록을 출력합니다." cellpadding="0" cellspacing="0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="left">
                                        <input id="eduSubTitle" name="eduSubTitle" title="소제목 입력" type="text" value='<c:out value="${articleVO.eduSubTitle}"/>' size="70" maxlength="70">
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <!--<tr>
                                    <th><label>강좌유형</label></th>
                                    <td class="left" colspan="3">
                                    	<input type="radio" name="eduStyle" value="1" <c:if test="${articleVO.eduStyle == 1}"> checked</c:if>> 히트 <span class="esBtn1">히트</span>
                                    	<input type="radio" name="eduStyle" value="2" <c:if test="${articleVO.eduStyle == 2}"> checked</c:if>> 신규 <span class="esBtn2">신규</span>
                                    	<input type="radio" name="eduStyle" value="3" <c:if test="${articleVO.eduStyle == 3}"> checked</c:if>> 인기 <span class="esBtn3">인기</span>
                                    	<input type="radio" name="eduStyle" value="4" <c:if test="${articleVO.eduStyle == 4}"> checked</c:if>> 할인 <span class="esBtn4">할인</span>
                                	</td>
                                </tr>-->
                                <tr>
                                    <th><label for="eduType">교육 클래스</label><span class="pilsu">*</span></th>
                                    <td class="left">
                                        <input id="eduTypeA" name="eduTypeA" type="text" value="<c:out value="${articleVO.eduTypeA}"/>" size="20" maxlength="20" style="width : 9%;">
                                        <input id="eduTypeB" name="eduTypeB" type="text" value="<c:out value="${articleVO.eduTypeB}"/>" size="20" maxlength="20" style="width : 9%;">
                                        <input id="eduTypeC" name="eduTypeC" type="text" value="<c:out value="${articleVO.eduTypeC}"/>" size="20" maxlength="20" style="width : 9%;">
                                        <input id="eduTypeD" name="eduTypeD" type="text" value="<c:out value="${articleVO.eduTypeD}"/>" size="20" maxlength="20" style="width : 9%;">
                                        <input id="eduTypeE" name="eduTypeE" type="text" value="<c:out value="${articleVO.eduTypeE}"/>" size="20" maxlength="20" style="width : 9%;">
                                        <input id="eduTypeF" name="eduTypeF" type="text" value="<c:out value="${articleVO.eduTypeF}"/>" size="20" maxlength="20" style="width : 9%;">
                                        <input id="eduTypeG" name="eduTypeG" type="text" value="<c:out value="${articleVO.eduTypeG}"/>" size="20" maxlength="20" style="width : 9%;">
                                        <input id="eduTypeH" name="eduTypeH" type="text" value="<c:out value="${articleVO.eduTypeH}"/>" size="20" maxlength="20" style="width : 9%;">
                                        <input id="eduTypeI" name="eduTypeI" type="text" value="<c:out value="${articleVO.eduTypeI}"/>" size="20" maxlength="20" style="width : 9%;">
                                        <input id="eduTypeJ" name="eduTypeJ" type="text" value="<c:out value="${articleVO.eduTypeJ}"/>" size="20" maxlength="20" style="width : 9%;">
                                	</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <th><label for="eduSdate">교육기간</label></th>
                                    <td class="left" colspan="3">
	                                   	<input id="eduSdate" type="text" name="eduSdate" size="15" maxlength="10" class="readOnlyClass" title="게시기간" readonly="readonly" style="width:100px" value="<c:out value="${fn:substring(articleVO.eduSdate,0,10)}"/>"/>
                                		&nbsp;~&nbsp;
                                		<input id="eduEdate" type="text" name="eduEdate" size="15" maxlength="10" class="readOnlyClass" title="게시기간" readonly="readonly" style="width:100px" value="<c:out value="${fn:substring(articleVO.eduEdate,0,10)}"/>"/>
                                	</td>
                                </tr>
                                <tr>
                                    <th><label for="eduOb">교육대상<span class="pilsu">*</span></label></th>
                                    <td class="left">
                                        <input id="eduOb" name="eduOb" title="교육대상 입력" type="text" value="<c:out value="${articleVO.eduOb}"/>" size="70" maxlength="70">
                                    </td>
                                </tr>
                                <tr>
                                    <th><label for="eduLocation">교육장소<span class="pilsu">*</span></label></th>
                                    <td class="left">
                                        <input id="eduLocation" name="eduLocation" title="교육장소 입력" type="text" value="<c:out value="${articleVO.eduLocation}"/>" size="70" maxlength="70">
                                    </td>
                                </tr>
                                <tr>
                                    <th><label for="eduPrice">수강료<span class="pilsu">*</span></label></th>
                                    <td class="left">
                                        <label><input name="eduPrice" type="radio" value="1" <c:if test="${articleVO.eduPrice == 1}"> checked</c:if>>무료(온라인)</label>
                                        <label><input name="eduPrice" type="radio" value="2" <c:if test="${articleVO.eduPrice == 2}"> checked</c:if>>유료(오프라인)</label>
                                    </td>
                                </tr>
                                <tr class="eduBox v_2" <c:if test="${articleVO.eduPrice == 1}">style="display:none"</c:if>>
                                    <th><label for="eduFee">참가비<span class="pilsu">*</span></label></th>
                                    <td class="left">
                                        <input id="eduFee" name="eduFee" title="참가비 입력" type="text" value="<c:out value="${articleVO.eduFee}"/>" size="70" maxlength="70">
                                    </td>
                                </tr>
                                <tr class="eduBox v_2" <c:if test="${articleVO.eduPrice == 1}">style="display:none"</c:if>>
                                    <th><label for="eduAcc">입금계좌<span class="pilsu">*</span></label></th>
                                    <td class="left">
                                        <input id="eduAcc" name="eduAcc" title="입금계좌 입력" type="text" value="<c:out value="${articleVO.eduAcc}"/>" size="70" maxlength="70">
                                    </td>
                                </tr>
                                <tr class="eduBox v_1" <c:if test="${articleVO.eduPrice == 2}">style="display:none"</c:if>>
                                    <th><label for="eduUrl">유투브링크<span class="pilsu">*</span></label></th>
                                    <td class="left">
                                        <input id="eduUrl" name="eduUrl" title="유투브링크" type="text" value="<c:out value="${articleVO.eduUrl}"/>" size="70" maxlength="70">
                                    </td>
                                </tr> 
                                <tr>
